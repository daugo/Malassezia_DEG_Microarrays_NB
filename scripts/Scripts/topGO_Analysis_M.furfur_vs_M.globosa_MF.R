...
nodes_table = 30
nodes_graph = 5
table_outfile_SAM <- 'GeneTable_M.furfur_vs_M.globosa_MF_SAM.txt'
table_outfile_Ebayes <- 'GeneTable_M.furfur_vs_M.globosa_MF_Ebayes.txt'
graph_outfile_SAM <- 'Graph_M.furfur_vs_M.globosa_MF_SAM.pdf'
graph_outfile_Ebayes <- 'Graph_M.furfur_vs_M.globosa_MF_Ebayes.pdf'
