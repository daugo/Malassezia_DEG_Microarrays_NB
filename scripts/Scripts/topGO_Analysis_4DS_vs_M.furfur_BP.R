...
nodes_table = 30
nodes_graph = 5
table_outfile_SAM <- 'GeneTable_4DS_vs_M.furfur_BP_SAM.txt'
table_outfile_Ebayes <- 'GeneTable_4DS_vs_M.furfur_BP_Ebayes.txt'
graph_outfile_SAM <- 'Graph_4DS_vs_M.furfur_BP_SAM.pdf'
graph_outfile_Ebayes <- 'Graph_4DS_vs_M.furfur_BP_Ebayes.pdf'
