...
nodes_table = 30
nodes_graph = 5
table_outfile_SAM <- 'GeneTable_4DST80_vs_4DS_CC_SAM.txt'
table_outfile_Ebayes <- 'GeneTable_4DST80_vs_4DS_CC_Ebayes.txt'
graph_outfile_SAM <- 'Graph_4DST80_vs_4DS_CC_SAM.pdf'
graph_outfile_Ebayes <- 'Graph_4DST80_vs_4DS_CC_Ebayes.pdf'
